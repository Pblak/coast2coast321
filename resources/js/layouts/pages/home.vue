<template>
    <div class="bg-gradient-to-l from-cyan-600 to-emerald-500">
        <div class="pt-24">
            <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                <!--Left Col-->
                <div class="flex flex-col text-white w-full md:w-3/5 justify-center items-start text-center md:text-left">
                    <h1 class="my-4 text-5xl font-bold leading-tight">
                        La solution aptimale pour la gestion du E-Commerce !
                    </h1>
                    <p class="leading-normal text-2xl mb-8">
                        Ne cherchez pas plus loin, Suivia s'en occupe de tout :)
                    </p>
                    <div class="flex content-between w-full z-30">

                        <router-link :to="{name:'login'}"
                                     class="mx-auto lg:mx-0  bg-white text-gray-800 font-bold rounded-full
                                     my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition
                                      hover:scale-105 duration-300 ease-in-out hover:border-white hover:bg-[#014984FF] hover:text-white">
                            Login
                        </router-link>

                        <router-link :to="{name:'register_cPanel'}"
                                     class="ml-10  border-gray-50  border-2 bg-transparant hover:text-fuchsia-200
                                      hover:bg-[#F9A61BFF] hover:border-white hover:text-black
                                     text-gray-100 font-bold rounded-full my-6 py-4 px-8 focus:shadow-outline transform transition
                ...
                <!--Right Col-->
                <div class=" w-full md:w-2/5 py-6 text-center flex-1">
                    <landingIcon />
                </div>
            </div>
        </div>
        <div class="relative -mt-12 lg:-mt-24">
            <svg version="1.1" viewBox="0 0 1428 174" xmlns="http://www.w3.org/2000/svg"
                ...
                <g fill="none" fill-rule="evenodd" stroke="none" stroke-width="1">
                    ...
                    <g fill="#FFFFFF" fill-rule="nonzero" transform="translate(-4.000000, 76.000000)">
                        <path
        ...
        <section class="bg-white border-b py-8">
            <div class="container max-w-5xl mx-auto m-8">
                <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
                    Vous êtes un E-commerçant et vous rencontrez des difficultés ?
                </h1>
                ...
                <div class="flex flex-wrap pt-4">
                    <div class="w-5/6 sm:w-1/2 p-6">
                        <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                            Suivia est la solution idéale pour vous
                        </h3>
                        <p class="text-gray-600 mb-8">
                            Grace à sa large platforme de modules et fonctionnalités qui couvrent
                            tous les aspects du E-commerce, elle vous permettra d'optimiser votre temps,
                            de réduire vos charges et de prendre les bonnes décisions stratégiques pour votre
                            croissance.
                    ...
                    <div class="w-full sm:w-1/2 p-6">
                        <svg class="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                ...
                                fill="#57b894"
                                transform="translate(-11.5 -150.75)"/>
                            <path d="M106,694.38a14,14,0,1,0-.68-11.3l8.77,7.13L104.46,688A14,14,0,0,0,106,694.38Z"
                                  fill="#57b894"
                                  transform="translate(-11.5 -150.75)"/>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-11.5 -150.75)"
                            />
                            <rect fill="#f2f2f2" height="456" rx="20.42" width="834" x="171.5" y="111.25"/>
                            ...
                            <path d="M387.5,490A66.5,66.5,0,1,1,321,423.5,66.47,66.47,0,0,1,387.5,490Z"
                                  fill="none" stroke="#f2f2f2"
                                  stroke-miterlimit="10" stroke-width="2" transform="translate(-11.5 -150.75)"/>
                            <path d="M325.38,467.23l8.3,13,35.53,55.59a66.5,66.5,0,0,1-103.32-8.57l43.54-84.94.91,1.43"
                                  fill="none"
                            ...
                            <path
                                ...
                                transform="translate(-11.5 -150.75)"
                            />
                            <path d="M337.5,452.5a15,15,0,0,1-12.12,14.73l-15-23.51a15,15,0,0,1,27.16,8.78Z"
                                  fill="none" stroke="#f2f2f2"
                                  stroke-miterlimit="10" stroke-width="2" transform="translate(-11.5 -150.75)"/>
                            <path d="m347.5 481.5" fill="none" stroke="#f2f2f2" stroke-miterlimit="10"
                                  stroke-width="2" transform="translate(-11.5 -150.75)"/>
                            <path d="m333.5 480.5" fill="none" stroke="#f2f2f2" stroke-miterlimit="10"
                                  stroke-width="2" transform="translate(-11.5 -150.75)"/>
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-11.5 -150.75)"
                            />
                            <rect fill="#ff6347" height="11" opacity=".3" rx="1.24" width="347" x="604" y="260.14"/>
                            <rect fill="#ff6347" height="11" opacity=".3" rx="1.24" width="347" x="604" y="392.07"/>
                            <rect fill="#ff6347" height="25" rx="1.24" width="73" x="878" y="279.75"/>
                            <rect fill="#ff6347" height="25" rx="1.24" width="73" x="878" y="411.75"/>
                            <path d="m978.18 606.93l-1.73 2s-21.05 2-20.2 5.39 25.35-4.55 25.35-4.55z"
                                  fill="#ffc1c7" transform="translate(-11.5 -150.75)"/>
                            <path
                ...
                <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                    ...
                    <div class="w-full sm:w-1/2 p-6 mt-6">
                        <div class="align-middle">
                            <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                                Un suivi hors pair et détaillé
                            </h3>
                            <p class="text-gray-600 mb-8">
                                La platforme Suivia vous offrera des statistiques et des analyses au fur et à mesure
                                de votre travail. Cela couvrera les : Clients, Produits, Wilayas, Bénifices et bien plus
                                encore.
                            </p>
                        </div>
                    </div>
        ...
        <section class="bg-white border-b py-8">
            ...
            <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Pourquoi nous choisir
                    ?</h1>
                <div class="w-full mb-4">
                    <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
                </div>

                <div class="w-full max-h-fit md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        <a class="flex flex-wrap no-underline hover:no-underline">
                            <p class="w-full text-gray-600 text-xs md:text-sm px-6 py-2">Interface</p>
                            <div class="w-full font-bold text-xl text-gray-800 px-6">Une interface facile à comprendre
                            </div>
                            <p class="text-gray-800 text-base px-6 mb-5">Suivia se présente sous la forme d'une
                                application web avec un design moderne et facile à comprendre, un petit tutorial vous
                                sera proposé lors de l'ouverture de votre compte.</p>
                        </a>
                    </div>
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        <a class="flex flex-wrap no-underline hover:no-underline">
                            <p class="w-full text-gray-600 text-xs md:text-sm px-6 py-2">Gestion</p>
                            <div class="w-full font-bold text-xl text-gray-800 px-6">Système de gestion optimal</div>
                            <p class="text-gray-800 text-base px-6 mb-5">Nous savons tous que le gestion E-Commerce
                                n'est pas simple, avec les produits en stock, les colis en cours de livraison ... etc.
                                Tous cela vous rends fou? la solution se trouve dans la rubrique Analyse de Suivia</p>
                        </a>
                    </div>
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        <a class="flex flex-wrap no-underline hover:no-underline">
                            <p class="w-full text-gray-600 text-xs md:text-sm px-6 py-2">Comptabilité</p>
                            <div class="w-full font-bold text-xl text-gray-800 px-6">Séparez vos bénifices de votre
                                capital
                            </div>
                            <p class="text-gray-800 text-base px-6 mb-5">Au fur et à mesure que vous avancez sur votre
                                travail, Suivia vous facilite grandement le calcule en vous aidant à savoir exactement
                                de combiens est votre bénifice net, votre capital en cours, et montant des produits en
                                stock</p>
                        </a>
                    </div>
        ...
        <section class="bg-gray-100 py-8">
            ...
            <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
                ...
                <h1 id="tarifs" class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Tarification</h1>
                <div class="w-full mb-4">
                    <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
                </div>
                    ...
                    <div
                        ...
                        <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                            ...
                            <ul class="w-full text-center text-base font-bold">
                                <li class="border-b py-4">Gestion des produits &amp; Clients</li>
                                <li class="border-b py-4">Centre de confirmation</li>
                                <li class="border-b py-4">Détéction des doubles commandes</li>
                                <li class="border-b py-4">5 comptes utilisateurs</li>
                                <li class="border-b py-4">5 livreurs</li>
                                <li class="border-b py-4">2000 commandes / mois</li>
                                <li class="border-b py-4">Préparation Excel d'éxpédition</li>
                            </ul>
                        </div>
                        <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                            <div class="w-full pt-6 text-4xl font-bold text-center">5000 DA<span class="text-base"> / Mois</span>
                            </div>
                            <div class="flex items-center justify-center">
                                <button
                                    class="transform transition
                                      hover:scale-105 duration-300 ease-in-out mx-auto text-blue-500  border-2 border-blue-500
                                      hover:bg-blue-500 hover:text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg">
                                    Choisir
                                </button>
                            </div>
                        </div>
        ...
        <section class="container mx-auto text-center py-6 mb-12">
            ...
            <router-link :to="{name:'login'}" class="bg-white text-gray-800
                font-bold rounded-full  py-4 px-8 shadow-lg">
                Let's GO !
            </router-link>
...
<!--            <div class="container mx-auto px-8">
                <div class="w-full flex flex-col md:flex-row py-6">
                    <div class="pr-10 flex-1 mb-6 text-black"> </div>
                    <div class="flex-1">
                        <p class="uppercase text-gray-500 md:mb-6">Links</p>
                        <ul class="list-reset mb-6">
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500"
                                   href="#">FAQ</a>
                            </li>
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500"
                            ...
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500" href="#">Support</a>
                            </li>
                        </ul>
                    </div>
                    <div class="flex-1">
                        ...
                        <ul class="list-reset mb-6">
                            ...
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500" href="#">Privacy</a>
                            </li>
                        </ul>
                    </div>
                    <div class="flex-1">
                        ...
                        <ul class="list-reset mb-6">
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500" href="#">Facebook</a>
                            </li>
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500" href="#">Linkedin</a>
                            </li>
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500" href="#">Twitter</a>
                            </li>
                        </ul>
                    </div>
                    <div class="flex-1">
                        ...
                        <ul class="list-reset mb-6">
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500" href="#">Official
                                    Blog</a>
                            </li>
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500" href="#">About
                                    Us</a>
                            </li>
                            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                                <a class="no-underline hover:underline text-gray-800 hover:text-pink-500" href="#">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<style scoped>
.onScroll {
    background: linear-gradient(70deg, #014984 50%, #105d9d 100%);
}

.gradient {
    background: linear-gradient(70deg, #014984 50%, #f9a61b 100%);
}
